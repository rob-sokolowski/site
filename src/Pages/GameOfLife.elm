module Pages.GameOfLife exposing (Model, Msg, page)

import Array exposing (Array)
import Browser exposing (element)
import Gen.Params.GameOfLife exposing (Params)
...
makeGrid : Int -> Int -> Cell -> Grid Cell
...
viewHtml model =
    div []
        [ div [] [ Html.text "Conway's Game of Life, in Elm!" ]
        , header []
            [ resetLink
