...
var $author$project$Gen$Route$Animation = {$: 'Animation'};
var $author$project$Gen$Route$GamedevFun = {$: 'GamedevFun'};
...
var $author$project$Gen$Params$Animation$parser = $elm$url$Url$Parser$s('animation');
var $author$project$Gen$Params$GamedevFun$parser = $elm$url$Url$Parser$s('gamedev-fun');
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Animation, $author$project$Gen$Params$Animation$parser),
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$GamedevFun, $author$project$Gen$Params$GamedevFun$parser),
...
var $author$project$Gen$Model$Animation = F2(
	function (a, b) {
		return {$: 'Animation', a: a, b: b};
	});
var $author$project$Gen$Msg$Animation = function (a) {
	return {$: 'Animation', a: a};
};
var $author$project$Gen$Model$GamedevFun = F2(
	function (a, b) {
		return {$: 'GamedevFun', a: a, b: b};
	});
var $author$project$Gen$Msg$GamedevFun = function (a) {
	return {$: 'GamedevFun', a: a};
};
...
var $author$project$Pages$Animation$init = _Utils_Tuple2(
	{},
	$author$project$Effect$none);
var $author$project$Pages$Animation$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Animation$update = F2(
	function (msg, model) {
...
var $author$project$Pages$Animation$animatedUi = $andrewMacmurray$elm_simple_animation$Simple$Animation$Animated$ui(
...
var $author$project$Pages$Animation$animatedEl = $author$project$Pages$Animation$animatedUi($mdgriffith$elm_ui$Element$el);
...
var $andrewMacmurray$elm_simple_animation$Internal$Ease$easeInOutQuad = A4($andrewMacmurray$elm_simple_animation$Internal$Ease$Cubic, 0.45, 0, 0.55, 1);
var $andrewMacmurray$elm_simple_animation$Simple$Animation$easeInOutQuad = $andrewMacmurray$elm_simple_animation$Internal$Animation$Ease($andrewMacmurray$elm_simple_animation$Internal$Ease$easeInOutQuad);
...
var $author$project$Pages$Animation$hoverAnimation = A2(
	$andrewMacmurray$elm_simple_animation$Simple$Animation$steps,
	{
		options: _List_fromArray(
			[$andrewMacmurray$elm_simple_animation$Simple$Animation$loop, $andrewMacmurray$elm_simple_animation$Simple$Animation$easeInOutQuad]),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(20)
				])),
			A2(
			$andrewMacmurray$elm_simple_animation$Simple$Animation$step,
			650,
...
var $author$project$Pages$Animation$animatedSquare = A3(
	$author$project$Pages$Animation$animatedEl,
	$author$project$Pages$Animation$hoverAnimation,
	_List_fromArray(
		[
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Pages$Animation$view = function (model) {
	return {
		body: _List_fromArray(
			[
				A2($mdgriffith$elm_ui$Element$layout, _List_Nil, $author$project$Pages$Animation$animatedSquare)
			]),
		title: 'Animation Playground'
	};
};
var $author$project$Pages$Animation$page = F2(
	function (shared, req) {
		return $author$project$Page$advanced(
			{init: $author$project$Pages$Animation$init, subscriptions: $author$project$Pages$Animation$subscriptions, update: $author$project$Pages$Animation$update, view: $author$project$Pages$Animation$view});
	});
var $author$project$Pages$GamedevFun$init = _Utils_Tuple2(
	{},
	$author$project$Effect$none);
var $author$project$Pages$GamedevFun$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$GamedevFun$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(model, $author$project$Effect$none);
	});
var $author$project$Pages$GamedevFun$view = function (model) {
	return $author$project$View$placeholder('Game dev is fun!');
};
var $author$project$Pages$GamedevFun$page = F2(
	function (shared, req) {
		return $author$project$Page$advanced(
			{init: $author$project$Pages$GamedevFun$init, subscriptions: $author$project$Pages$GamedevFun$subscriptions, update: $author$project$Pages$GamedevFun$update, view: $author$project$Pages$GamedevFun$view});
	});
...
var $author$project$Pages$Home_$blue = A3($mdgriffith$elm_ui$Element$rgb, 0, 0.4, 0.7);
...
var $author$project$Pages$Home_$viewElement = A2(
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('Hello world, some WIP links..'),
			A2(
			$mdgriffith$elm_ui$Element$link,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$color($author$project$Pages$Home_$blue)
				]),
			{
				label: $mdgriffith$elm_ui$Element$text('Animation'),
				url: '/animation'
			}),
			A2(
			$mdgriffith$elm_ui$Element$link,
			...
			{
				label: $mdgriffith$elm_ui$Element$text('GameDev fun'),
				url: '/gamedev-fun'
			})
		]));
var $author$project$Pages$Home_$view = {
	body: _List_fromArray(
		[
			A2($mdgriffith$elm_ui$Element$layout, _List_Nil, $author$project$Pages$Home_$viewElement)
		]),
	title: 'Homepage'
};
var $author$project$Pages$NotFound$view = $author$project$View$placeholder('Page not found.');
var $author$project$Gen$Pages$pages = {
	animation: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Animation$page, $author$project$Gen$Model$Animation, $author$project$Gen$Msg$Animation),
	gamedevFun: A3($author$project$Gen$Pages$bundle, $author$project$Pages$GamedevFun$page, $author$project$Gen$Model$GamedevFun, $author$project$Gen$Msg$GamedevFun),
...
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		case 'Animation':
			return $author$project$Gen$Pages$pages.animation.init(_Utils_Tuple0);
		case 'GamedevFun':
			return $author$project$Gen$Pages$pages.gamedevFun.init(_Utils_Tuple0);
		case 'Home_':
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Animation':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.animation.subscriptions, params, model);
		case 'GamedevFun':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.gamedevFun.subscriptions, params, model);
		case 'Home_':
			var params = model_.a;
		...
		while (true) {
			if (_v0.a.$ === 'Animation') {
				if (_v0.b.$ === 'Animation') {
					...
					var params = _v1.a;
					var model = _v1.b;
					return A3($author$project$Gen$Pages$pages.animation.update, params, msg, model);
				} else {
					break _v0$2;
				}
			} else {
				if (_v0.b.$ === 'GamedevFun') {
					...
					var params = _v2.a;
					var model = _v2.b;
					return A3($author$project$Gen$Pages$pages.gamedevFun.update, params, msg, model);
				} else {
					break _v0$2;
				}
			}
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Animation':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.animation.view, params, model);
		case 'GamedevFun':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.gamedevFun.view, params, model);
		case 'Home_':
			var params = model_.a;
